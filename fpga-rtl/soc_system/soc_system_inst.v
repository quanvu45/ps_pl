	soc_system u0 (
		...
		.msg_irq_pio_external_connection_export (<connected-to-msg_irq_pio_external_connection_export>), // msg_irq_pio_external_connection.export
		.msg_mem_0_fpga_mem_address             (<connected-to-msg_mem_0_fpga_mem_address>),             //              msg_mem_0_fpga_mem.address
		.msg_mem_0_fpga_mem_read                (<connected-to-msg_mem_0_fpga_mem_read>),                //                                .read
		.msg_mem_0_fpga_mem_write               (<connected-to-msg_mem_0_fpga_mem_write>),               //                                .write
		.msg_mem_0_fpga_mem_writedata           (<connected-to-msg_mem_0_fpga_mem_writedata>),           //                                .writedata
		.msg_mem_0_fpga_mem_readdata            (<connected-to-msg_mem_0_fpga_mem_readdata>),            //                                .readdata
